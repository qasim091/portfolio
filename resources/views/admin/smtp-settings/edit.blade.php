...
@section('page-title', 'Edit SMTP Settings')
...
<div class="max-w-3xl">
    <div class="bg-card rounded-xl border border-border/50 shadow-sm p-6">
        <form action="{{ route('admin.smtp-settings.update', $smtpSetting) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <select id="mail_mailer" 
                        ...
                        required>
                    <option value="smtp" {{ old('mail_mailer', $smtpSetting->mail_mailer) === 'smtp' ? 'selected' : '' }}>SMTP</option>
                </select>
                @error('mail_mailer')
            ...
            <div>
                ...
                <input type="number" 
                       id="mail_port" 
                       name="mail_port" 
                       value="{{ old('mail_port', $smtpSetting->mail_port) }}"
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-muted-foreground">Leave blank to keep the current password</p>
                @error('mail_password')
                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                @enderror
            </div>
                ...
                <div class="flex gap-3">
                    ...
                    <div class="text-sm text-foreground">
                        ...
                        <ul class="list-disc list-inside space-y-1 text-muted-foreground">
                            <li>Changes will be saved to your database and .env file</li>
                            <li>Config cache will be cleared automatically</li>
                            <li>Leave password field blank to keep the existing password</li>
                        </ul>
                    </div>
                </div>
            </div>
